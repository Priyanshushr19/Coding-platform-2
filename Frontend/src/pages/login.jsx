...
import { Eye, EyeOff, Sparkles, Code, ArrowRight, Shield, Zap, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-black relative overflow-hidden">
      ...
      {error && (
        <div className="absolute top-4 right-4 z-50 animate-slideIn">
          <div className="bg-red-500/90 backdrop-blur-md border border-red-400 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="text-right">
                <button 
                  type="button"
                  className="text-sm text-purple-400 hover:text-purple-300 transition-colors hover:underline underline-offset-2"
                >
                  Forgot Password?
                </button>
              </div>
            ...
            <div className="mt-4 p-3 bg-purple-500/5 rounded-lg border border-purple-500/20">
              <p className="text-xs text-purple-300/70 text-center mb-2">Demo Credentials</p>
