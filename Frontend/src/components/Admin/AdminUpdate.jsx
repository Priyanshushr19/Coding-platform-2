...
import { 
  Edit, RefreshCw, Search, Filter, 
  ChevronLeft, ChevronRight, AlertCircle,
  Loader, Sparkles, Zap, Shield, Code,
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div className="animate-slideIn">
            <div className="flex items-center gap-3 mb-2">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg blur opacity-70 animate-pulse"></div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          className="group/btn relative px-3 py-1.5 bg-blue-500/10 border border-blue-500/30 rounded-lg text-blue-400 hover:text-white hover:border-blue-400 hover:bg-blue-500/20 transition-all duration-300 overflow-hidden"
                        >
        ...
        {/* Info Message */}
        <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg animate-slideIn animation-delay-800">
          <div className="flex items-start gap-3">
            <Shield size={20} className="text-blue-400 flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-medium text-blue-300 mb-1">Update Information</h3>
              <p className="text-sm text-blue-300/70">
                Click the Update button next to any problem to modify its details. You can edit the title, description, test cases, and code templates.
              </p>
            </div>
          </div>
        </div>
